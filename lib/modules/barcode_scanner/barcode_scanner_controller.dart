...
part 'barcode_scanner_controller.g.dart';

class BarcodeScannerController = _BarcodeScannerControllerBase
    with _$BarcodeScannerController;

abstract class _BarcodeScannerControllerBase with Store {
  @observable
